...
class User
  ...
  attr_accessor :identity, :identity_type, :invalid_identity, :legal_identity, :legal_identity_type,
                :legal_formatted_identity, :name, :person_identity, :person_identity_type,
                :person_formatted_identity, :unique_identity

  validates :identity, identity: { identity_type: :identity_type }
  validates :invalid_identity, identity: { identity_type: :invalid_identity_type }
  ...
  validates :unique_identity, identity: { only: :Test }
end
